<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="ChiTietBaiViet.aspx.cs" Inherits="ClientViVuTraVinh.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div id="mt_banner" class="innerbanner" style="height: 460px;">
    	<div class="container-fluid">
    		<div class="featured-image" style="background-image: url(/Resources/images/slider/bg2.jpg)"></div>
            ...
            <div class="blog-detail-main">
	            ...
	            <div class="author_box">
	                <div class="author_img">
	                    <img src="/Resources/images/blog/author.png" alt="Author">
	                </div>
	                    ...
	                    <ol class="comments-lists">
	                        <li class="comment">
	                            <div class="activity_rounded">
	                                <img src="/Resources/images/blog/cmnt-1.jpg" alt="image"> </div>
	                            ...
	                            <ol class="children">
	                                <li class="comment">
	                                    <div class="activity_rounded">
	                                        <img src="/Resources/images/blog/cmnt-2.jpg" alt="image"> </div>
	                                    <div class="comment-body">
	                                        <h4 class="text-left"> NIKLOS DELSON &nbsp;&nbsp;
	                                            <small class="date-posted pull-right">18th Mar, 2018</small>
	                                        </h4>
	                        ...
	                        <li class="comment">
	                            <div class="activity_rounded">
	                                <img src="/Resources/images/blog/cmnt-3.jpg" alt="image"> </div>
	                            <div class="comment-body">
	                                <h4 class="text-left"> NIKLOS DELSON &nbsp;&nbsp;
	                                    <small class="date-posted pull-right">18th Mar, 2018</small>
	                                </h4>
                	...
                	<div class="col-md-8 col-sm-12 mar-bottom-30">
                        <div class="blog-post_wrapper image-wrapper">
                            <div class="blog-post-image">
                                <img src="/Resources/images/blog-listing/blog_02.jpg" alt="image" class="img-responsive center-block post_img">
                            </div>
